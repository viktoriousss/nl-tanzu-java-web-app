...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=viktoriousss&repo=nl-tanzu-java-web-app",
  "projectName" : "nl-tanzu-java-web-app",
  "repositoryPrefix" : "nl-tanzu-java-web-app"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->nl-tanzu-java-web-ap...(truncated)]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.merge.transformations[0].sources[1].<combo>.transformations[2] (ReplaceText)
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->nl-tanzu-java-web-ap...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [: tanzu-java-web-app->: nl-tanzu-java-web-...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=viktoriousss&repo=nl-tanzu-java-web-app'
